...
// Povorot.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPovorotApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CPovorotApp

CPovorotApp::CPovorotApp()
{
...
// Единственный объект CPovorotApp

CPovorotApp theApp;


// инициализация CPovorotApp

BOOL CPovorotApp::InitInstance()
{
